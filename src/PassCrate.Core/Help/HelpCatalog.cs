...
public static class HelpCatalog
{
    ...
    [
        Topic(
            ...
            "Before the first create or restore flow, PassCrate asks you to review and accept its current Terms of Use, Privacy Policy, and data-loss warning. Creating then continues to passphrase setup; restoring asks you to connect the cloud account holding the encrypted backup.",
        ...
        Topic(
            HelpTopicIds.LegalAcceptance,
            HelpCategory.GettingStarted,
            "Important Information",
            "Terms, privacy, and data responsibility",
            "Review the data-loss warning, Terms of Use, and Privacy Policy before creating or restoring a vault.",
            ["terms", "privacy", "disclaimer", "warranty", "liability", "accept", "data loss", "first setup"],
            "This page appears before the first Create Vault or Restore from Cloud flow on a new or reset installation, and appears again when the legal-document versions materially change.",
            [
                "Read the passphrase, backup, software-error, cloud-provider, and legal-rights notices.",
                "Open the complete offline Terms of Use and Privacy Policy using their buttons.",
                "Open Backup & Recovery Help if you need more detail about avoiding data loss.",
                "Select the acceptance checkbox, then tap Accept and continue, or tap Cancel to return to Welcome.",
            ],
            "PassCrate stores a local receipt containing the accepted Terms version, Privacy version, app version, and acceptance time, then continues to the create or restore page you selected.",
            "Acceptance does not guarantee recovery or remove rights that applicable law does not allow to be excluded. The legal pages are offline and never read vault data. Reset clears the receipt, so acceptance is required again.",
            Trouble(
                ("Accept and continue is disabled", "Read the notices and documents, then select the unchecked acceptance box."),
                ("You do not agree", "Tap Cancel. PassCrate will return to Welcome without creating, restoring, or changing a vault."),
                ("The page appears again", "A reset removed the local receipt, or the Terms or Privacy Policy version changed and needs renewed acceptance.")),
            [HelpScreenIds.LegalAcceptance, HelpScreenIds.LegalDocument]),
        ...
        Topic(
            ...
            "Changing the passphrase updates how this device unlocks the vault and, when cloud sync is enabled, replaces the authoritative cloud recovery information. It does not rename, remove, or recreate your saved items.",
            [
        ...
        Topic(
            ...
            [
                ...
                "When backups are found, choose one using its readable last-updated date. The most recent backup is marked Recommended.",
                "Enter the original vault passphrase that protected that backup.",
                "Tap Restore my vault.",
            ],
            "The passphrase field appears only after at least one backup is available. PassCrate automatically restores the newest valid saved state inside the backup you select; technical version identifiers are not shown. A successful restore creates the local vault and opens it on this device.",
        ...
        Topic(
            ...
            ["cloud", "sync", "Google Drive", "Dropbox", "Wi-Fi", "sync now", "disconnect", "delete cloud", "reconnect", "different vault", "replace backup", "merge vault", "another account"],
        ...
        Topic(
            ...
            ["conflict", "revision", "merge", "keep both", "deleted group", "reveal", "combine", "cloud sync off", "no conflicts"],
            "A conflict is created when PassCrate cannot safely choose between versions from different devices, such as simultaneous offline edits or a deletion that competes with another change. Conflict Review is available only after cloud sync is enabled.",
            [
                "If cloud sync is off, open Cloud sync settings and connect Google Drive or Dropbox first.",
                "If the page says No conflicts to review, there is nothing you need to choose.",
                "When conflicts exist, choose an item under Items needing your choice.",
                ...
                "For a secret conflict, choose Keep both secret versions when both records should remain.",
                "For deletions, choose Keep it deleted, bring a deleted group back, or move its secrets before deleting the group as offered.",
            ],
            "Only actions that apply to the selected conflict are shown. After a choice is saved, PassCrate queues the resolved result for cloud synchronization.",
